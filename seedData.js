...
async function seed() {
  try {
    ...
    const courseEnA1 = await CourseLevel.create({
      ...
      thumbnail_url: "https://images.unsplash.com/photo-1513635269975-59663e0ca1ad?w=600&h=400&fit=crop",
      status: "published",
      enrolled_count: 2,
      rating: 4.7,
      display_order: 1
    ...
    const courseFrA1 = await CourseLevel.create({
      ...
      thumbnail_url: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&h=400&fit=crop",
      status: "published",
      enrolled_count: 1,
      rating: 4.9,
      display_order: 1
    ...
    const courseJaN5 = await CourseLevel.create({
      ...
      thumbnail_url: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&h=400&fit=crop",
      status: "published",
      enrolled_count: 1,
      rating: 4.8,
      display_order: 1
